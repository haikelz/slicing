...
export default function GrolinRegister() {
  return (
        ...
        <div className="flex w-full items-center justify-center md:p-10">
          <div className="flex w-full flex-col items-start justify-center">
            ...
            <div className="mt-5 w-full md:mt-0">
              <span className="text-[32px] font-semibold">Register</span>
              <p className="mb-6 mt-[10px] text-white/60">Enter your user details below.</p>
            </div>
            <div className="mt-5 w-full space-y-5">
              <div className="flex flex-col">
                ...
                <input className="rounded-md bg-[#33394F] px-8 py-4" type="text" name="name" />
              </div>
              <div className="flex flex-col">
                <label className="mb-1 font-semibold" htmlFor="email">
                  Email
              ...
              <div className="flex flex-col">
                <label className="mb-1 font-semibold" htmlFor="password">
                  Password
                </label>
                <input
            ...
            <div className="flex w-full items-center justify-center text-center">
              <span className="mt-10 font-semibold text-white/60">
                Have an account? <span className="text-[#FC728B]">Login!</span>
              </span>
            </div>
          </div>
        </div>
